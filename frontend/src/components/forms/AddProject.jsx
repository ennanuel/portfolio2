...
import '../../styles/addproject/addproject.css';
...
const AddProject = ({}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
          if (values.type === 'main') await fetch(`${apiUrl}/upload`, { body, formData });
    ...
    const changeState = (e) => {
      if(e.target.id === 'image') {
        ...
        setUploadedImg(file)
        setValues(prev => ({...prev, image: `${file.name}`, fileName: file.name}))
      }
